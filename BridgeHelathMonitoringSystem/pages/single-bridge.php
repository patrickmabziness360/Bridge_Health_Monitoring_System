...
if (isset($_GET['id']) && !empty($_GET['id'])) {
  $id = $_GET['id'];
  $bridge_information = $conn->query("SELECT LTP.*, LTPF.Caption,LTPF.AttachmentName,d.Water_level,d.CrackDepth,
...
// }
$sql = "SELECT ID, StrainOnBridge, Water_Level,CrackDepth,TIME(CreatedAt) AS CreatedTime FROM bridge.tblBridgeSensorData WHERE BridgeID =$id ORDER BY CreatedAt DESC LIMIT 14;";
          ...
          <div class="row">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="title-wrapper pt-30 ">
                        <div class="row align-items-center">
                          <div class="col-md-6 align-items-center">
                            <div class="title mb-30">
                              ...
                              <h3>Bridge Name : <span
                                  class="<?= $info['BridgeStatus'] === 'SAFE TO USE' ? 'text-success' : 'text-danger' ?>">
                                  <?= $resultw['Name']; ?> Details</span></h3>
                              <h5>Location : <span
                                  class="<?= $info['BridgeStatus'] === 'SAFE TO USE' ? 'text-success' : 'text-danger' ?>">
                                  <?= $resultw['Location']; ?> Details</span></h5>
                              <h5> Status : <span
                                  class="<?= $info['BridgeStatus'] === 'SAFE TO USE' ? 'text-success' : 'text-danger' ?>">
                                  <?= $info['BridgeStatus']; ?></span></h5>

                              <h5 class="text-enter">Date :
                        ...
                        <div class="row">
                            ...
                            <div class="card-style mb-30 <?= $info['Tilt'] === 'HIGH TILT' ? 'bg-danger' : '' ?>">
                              <div class="card-body" style="height: 170px;">
                                ...
                                <p class="card-text font-weight-400">
                                  <span class="<?= $info['Tilt'] === 'HIGH TILT' ? 'text-white' : 'text-black' ?>">The
                                    Bridge is:</span>
                          ...
                          <div class="col-lg-4">
                            <div class="card-style mb-30 <?= $info['CrackDepth'] > 13 ? 'bg-danger' : '' ?>">
                              <div class="card-body" style="height: 170px;">
                                ...
                                <p class="card-text">
                                  <span class="<?= $info['CrackDepth'] > 13 ? 'text-white' : 'text-black' ?>"> Biggest
                                    Crack:</span>
                          ...
                          <div class="col-lg-4">
                            <div class="card-style mb-35 <?= $info['StrainOnBridge'] > 170. ? 'bg-danger' : '' ?>">
                              <div class="card-body" style="height: 300px;">
                                <h5 class="card-title">Strain Details</h5>
                                <p class="card-text">
                                  <span class="<?= $info['CrackDepth'] > 170. ? 'text-white' : 'text-black' ?>"> Max
                                    weight:</span> <span
                                    class="<?= $info['StrainOnBridge'] > 170. ? 'text-white' : 'text-success' ?> title">50
                                    tons</span>
                                </p>
                                <p class="card-text">
                                  <span class="<?= $info['CrackDepth'] > 170. ? 'text-white' : 'text-black' ?>"> Current
                                    weight:</span> <span
                                    class="<?= $info['StrainOnBridge'] > 170. ? 'text-white' : ($info['StrainOnBridge'] < 30 ? 'text-success' : ($info['StrainOnBridge'] < 170. ? 'text-success' : 'text-danger')) ?>">
                                    <?= ($info['StrainOnBridge'] < 30) ? 0 : $info['StrainOnBridge'] - 107 ?> tons
                                  </span>
                                </p>
                                <p class="card-text">
                                  <span class="<?= $info['CrackDepth'] > 170. ? 'text-white' : 'text-black' ?>">
                                    status:</span> <span
                                    class="<?= $info['StrainOnBridge'] > 170. ? 'text-white' : ($info['StrainOnBridge'] > 30 ? 'text-danger' : 'text-success') ?>">
                                    <?= $info['StrainOnBridge'] > 170. ? 'Temporarily closed' : 'Safe to use' ?>
                                  </span>
                                </p>
                              </div>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        ...
                        <div class="rotate-img">
                          Picture
                          <img src="<?= $relative_path; ?>upload/<?= $resultw['AttachmentName']; ?>" alt="banner"
            ...
            <div class="col-lg-4">
              ...
              while ($row = $nearestBridges->fetch_assoc()) { ?>
                <div class="row ml-2">
                  <a href="single-bridge.php?id=<?= $row['BridgeID']; ?>"
                    style="color: #032a63 !important;text-decoration: none;">
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                          <div class="col-sm-7">
                            ...
                            <div class="fs-12">
                              ...
                              <div
                                class="badge <?= ($row['RoadStatus'] == 'CLOSED') ? 'badge-danger' : 'badge-primary' ?> fs-12 font-weight-bold mb-3">
                                <?= $row['RoadStatus']; ?>
                              </div>
                            </div>
                            <div class="col-sm-5">
                              <div class="rotate-img">
                                <img src="<?= $relative_path; ?>upload/<?= $row['AttachmentName']; ?>" alt="banner"
                                  class="img-fluid" />
                              </div>
                            </div>
                          </div>
